                ...
                <div className="relative">
                  ...
                  {index === currentSlideIndex && (
                    <div className="absolute right-1/2 bottom-0 z-20 translate-x-1/2 translate-y-1/2 cursor-pointer">
                      <div className="bg-primary rounded-full border border-white p-1 shadow-md md:p-1.5 lg:border-[3px] lg:p-2 lg:shadow-lg xl:p-2.5">
                        <svg
                          ...
                          viewBox="0 0 32 31"
                          fill="none"
                          className="size-2.5 md:size-3 lg:size-4.5 xl:size-6"
                        >
                          <path
